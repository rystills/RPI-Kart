...
public class GameOverUI : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        GUI.Label(new Rect(native_width / 2 - 400, native_height / 2 - 400, 800, 300), "Game Over", centeredStyle);
        if (GUI.Button(new Rect(native_width / 2 - 700, native_height / 2, 200, 100), "Retry", menuButtonStyle))
